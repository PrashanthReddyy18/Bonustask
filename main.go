...
func main() {
	...
	tweetText := fmt.Sprintf("Hello from Prashanth %s!", time.Now().Format(time.RFC3339))
	...
	// Ask for consent to delete the tweet
	reader := bufio.NewReader(os.Stdin)
	fmt.Print("Do you want to delete this tweet? (yes/no): ")
